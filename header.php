  ...
  <nav class="navbar navbar-expand-lg fixed-top navbar-dark">
    <div class="container">
      <?php
        ...
        if ( has_custom_logo() ) {
          echo '<a class="navbar-brand" href="index.html"><img height="30" src="' . $logo[0] . '" alt="' . get_bloginfo( 'name' ) . '"/></a>';
        } else {
          echo '<a class="navbar-brand" href="index.html"><h3>'. bloginfo('name') .'</h3></a>';
        }
      ?>
